...
const menu = {
   ...
   downloader: ["tiktokdl <url>", "igdl <url>"],
   group: ["hidetag", "add <nomor>", "welcome", "leaving", "setprofile", "setname", "linkgroup"],
   tool: ["fetch <url>", "rvo"]
}
...
export default {
   ...
   options: {
      ...
      owner: ["62882163353091"], // set owner number on here
      sessionName: "session", // for name session
      openaiKey: "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",
      prefix: /^[°•π÷×¶∆£¢€¥®™+✓_=|/~!?@#%^&.©^]/i
   },

   // Set pack name sticker on here
   Exif: {
      packId: "https://youtube.com/@FarelAE",
      packName: `Sticker Ini Dibuat Oleh :`,
      packPublish: "Dika Ardnt.",
      packEmail: "okeae2410@gmail.com",
      packWebsite: "https://youtube.com/@FarelAE",
...
global.tekspushkon = ""
global.otakudesulink = 'https://otakudesu.cam'
global.inststalklink = 'https://www.inststalk.com'
global.videodownloaderlink = 'https://videodownloader.so'
global.picukilink = 'https://picuki.me'
